...
零次微分形式——函数 <body>$f$/></body>



一次微分形式——线积分<body><img src="/Lolitalim.github.io/docs/assets/img/ExteriorDerivativeInCalculus/001.png" alt="test" style="width:128px;height:128px;" /></body>中出现的微分dx,dy,dz的一次式
